"""Training loop for audio upscaler models."""
...
from ..losses import CombinedAudioLoss
...
class Trainer:
    """Manages training, validation, checkpointing, and TensorBoard logging.

    Args:
        model:           PyTorch model (WaveformUNet or STFTUNet)
    ...
    def __init__(
        ...
        self.scaler = GradScaler(enabled=(tc.get("mixed_precision", True) and device != "cpu"))
    ...
    def _save_checkpoint(self, epoch: int | str) -> None:
